...
const Navbar = ({ mode }) => {
  ...
  return (
    <div
      className={`space-x-5 max-[380px]:h-20 max-[420px]:h-[5rem] max-[450px]:h-[6rem] md:max-lg:h-[6.5rem]  flex justify-around items-center  md:max-[850px]:h-32 lg:h-32 xl:max-2xl:space-x-96 xl:max-2xl:h-[9rem] lg:space-x-80 ${mode === "Dark" && "bg-[#151515]"
        }`}
    >
      <div className="logo  flex justify-center items-center">
        <motion.svg
          ...
          fill="#ffffff"
          version="1.1"
          className="md:h-[5.5rem] md:w-[5.5rem] lg:h-[6rem] lg:w-[6rem] xl:max-2xl:h-[8rem] xl:max-2xl:w-[8rem]"
          height="4rem"
          width="4rem"
          id="Layer_1"
      ...
      <div className="title flex justify-center items-center  h-[3.5rem]  ">
        <motion.h2
          className="font-[poppins]  text-3xl mt-[1rem] md:max-lg:text-[2.5rem] font-medium text-white lg:text-[3rem] xl:max-2xl:text-[4rem]"
          animate={{ y: -10 }}
          initial={{ y: -250 }}
